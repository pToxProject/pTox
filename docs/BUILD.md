...
Following are barebone compilation instructions. They probably won't work but #ptox on freenode can
...
The easy way out is:
```sh
git clone --recursive git://github.com/pToxProject/pTox.git
cd pTox/
mkdir build
cd build
cmake ..
